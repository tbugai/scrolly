...
describe("scrolly plugin", function() {
	beforeEach(function() {
		support.inject("<style type='text/css'>.portal { position:relative; } .content { position:absolute; } .left-side, .right-side { width: 25px; }</style>");
		$base = support.inject("<div id='test'>Some context here</div>")
		$base.width(150);
	...
	context("setup", function() {
		it("should add the 'scrolly' class to the base", function() {
			expect($base).toHaveClass("scrolly");
		});
